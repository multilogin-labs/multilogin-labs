...
```bash
npm run api:search -- profile update metadata
```
...
Search [SEARCH_KEYWORDS.md](../SEARCH_KEYWORDS.md) for: `profile update metadata`.
...
**Keywords:** multilogin api cookbook · profile update metadata
