# Cookbook 39: Workspace member workflow

> [Partner pricing →](https://multilogin.com/pricing/?utm_source=saas&utm_medium=partner&a_aid=saas&a_bid=f5fad549)

See [cookbook 20](20-bulk-stop-and-restart.md) for patterns. Search endpoints: `npm run api:search -- workspace member invite`
