# Cookbook 41: Audit cookies across many profiles
...
Audit cookies across many profiles — production-ready pattern using Multilogin X API.
...
```bash
npm run api:search -- cookies audit compliance
# or
npx mlx-labs search cookies audit compliance
```
...
// Implement: audit cookies across many profiles
```
...
**Keywords:** multilogin api cookbook · cookies audit compliance
