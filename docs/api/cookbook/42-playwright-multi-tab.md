# Cookbook 42: Multi-tab Playwright workflow
...
Multi-tab Playwright workflow — production-ready pattern using Multilogin X API.
...
```bash
npm run api:search -- playwright tabs context
# or
npx mlx-labs search playwright tabs context
```
...
// Implement: multi-tab playwright workflow
```
...
**Keywords:** multilogin api cookbook · playwright tabs context
