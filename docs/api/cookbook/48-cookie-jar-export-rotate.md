# Cookbook 48: Cookie jar rotation helper
...
Cookie jar rotation helper — production-ready pattern using Multilogin X API.
...
```bash
npm run api:search -- cookie rotate jar
# or
npx mlx-labs search cookie rotate jar
```
...
// Implement: cookie jar rotation helper
```
...
**Keywords:** multilogin api cookbook · cookie rotate jar
