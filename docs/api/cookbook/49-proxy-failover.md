# Cookbook 49: Proxy failover and retry logic
...
Proxy failover and retry logic — production-ready pattern using Multilogin X API.
...
```bash
npm run api:search -- proxy failover retry
# or
npx mlx-labs search proxy failover retry
```
...
// Implement: proxy failover and retry logic
```
...
**Keywords:** multilogin api cookbook · proxy failover retry
