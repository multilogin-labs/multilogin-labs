# Cookbook 50: Bulk rename tags across profiles
...
Bulk rename tags across profiles — production-ready pattern using Multilogin X API.
...
```bash
npm run api:search -- tag rename bulk
# or
npx mlx-labs search tag rename bulk
```
...
// Implement: bulk rename tags across profiles
```
...
**Keywords:** multilogin api cookbook · tag rename bulk
