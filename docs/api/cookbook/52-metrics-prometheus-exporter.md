# Cookbook 52: Prometheus metrics exporter shape
...
Prometheus metrics exporter shape — production-ready pattern using Multilogin X API.
...
```bash
npm run api:search -- prometheus metrics
# or
npx mlx-labs search prometheus metrics
```
...
// Implement: prometheus metrics exporter shape
```
...
**Keywords:** multilogin api cookbook · prometheus metrics
