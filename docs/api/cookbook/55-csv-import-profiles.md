# Cookbook 55: Import profiles from CSV
...
Import profiles from CSV — production-ready pattern using Multilogin X API.
...
```bash
npm run api:search -- csv import bulk profiles
# or
npx mlx-labs search csv import bulk profiles
```
...
// Implement: import profiles from csv
```
...
**Keywords:** multilogin api cookbook · csv import bulk profiles
