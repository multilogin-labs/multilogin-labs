# Cookbook 59: Agency onboarding script
...
Agency onboarding script — production-ready pattern using Multilogin X API.
...
```bash
npm run api:search -- agency onboarding
# or
npx mlx-labs search agency onboarding
```
...
// Implement: agency onboarding script
```
...
**Keywords:** multilogin api cookbook · agency onboarding
