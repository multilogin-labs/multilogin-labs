# Cookbook 64: Minimal Rust client snippet
...
Minimal Rust client snippet — production-ready pattern using Multilogin X API.
...
```bash
npm run api:search -- rust client reqwest
# or
npx mlx-labs search rust client reqwest
```
...
# Minimal Rust client snippet — implement the flow with the endpoints printed above
```
...
// minimal rust client snippet — wire to your scheduler / queue
```
...
**Keywords:** multilogin api cookbook · rust client reqwest
