# Cookbook 67: Pytest fixtures for Multilogin tests
...
Pytest fixtures for Multilogin tests — production-ready pattern using Multilogin X API.
...
```bash
npm run api:search -- pytest fixtures conftest
# or
npx mlx-labs search pytest fixtures conftest
```
...
# Pytest fixtures for Multilogin tests — implement the flow with the endpoints printed above
```
...
// pytest fixtures for multilogin tests — wire to your scheduler / queue
```
...
**Keywords:** multilogin api cookbook · pytest fixtures conftest
