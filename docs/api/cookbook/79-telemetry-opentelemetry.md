# Cookbook 79: OpenTelemetry traces for profile ops
...
OpenTelemetry traces for profile ops — production-ready pattern using Multilogin X API.
...
```bash
npm run api:search -- opentelemetry tracing
# or
npx mlx-labs search opentelemetry tracing
```
...
# OpenTelemetry traces for profile ops — implement the flow with the endpoints printed above
```
...
// opentelemetry traces for profile ops — wire to your scheduler / queue
```
...
**Keywords:** multilogin api cookbook · opentelemetry tracing
