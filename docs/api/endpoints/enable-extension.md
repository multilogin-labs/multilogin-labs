...
- [Python example](../examples/python/enable-extension.md) · [Node](../examples/node/enable-extension.md)
- [Cookbook](../cookbook/README.md) · [mlx_client.py](../../../lib/mlx_client.py)

## Search terms

`multilogin api enable extension` · `multilogin x enable extension`
