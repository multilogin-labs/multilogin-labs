...
1. Avoid datacenter IPs on Google/login flows.
2. Use [fingerprint masking](multilogin-fingerprint-masking.md).
...
**Keywords:** multilogin captcha fingerprint · multilogin x · multilogin labs
