...
Operators in **Argentina** use Multilogin for multi-account social, e-commerce, and ads. Currency: **ARS**. Popular stacks: Mercado Libre, Meta LATAM.

## Recommended setup

| Item | Recommendation |
|---|---|
| Proxy | Residential or mobile in **AR** |
...
1. Create folder `ar-clients` in workspace.
2. One profile per account — tag `geo-ar`.
