...
Operators in **Australia** use Multilogin for multi-account social, e-commerce, and ads. Currency: **AUD**. Popular stacks: Amazon AU, eBay AU, TikTok AU.

## Recommended setup

| Item | Recommendation |
|---|---|
| Proxy | Residential or mobile in **AU** |
...
1. Create folder `au-clients` in workspace.
2. One profile per account — tag `geo-au`.
