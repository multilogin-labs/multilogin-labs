...
Operators in **Canada** use Multilogin for multi-account social, e-commerce, and ads. Currency: **CAD**. Popular stacks: Amazon CA, Shopify, Meta Ads NA.

## Recommended setup

| Item | Recommendation |
|---|---|
| Proxy | Residential or mobile in **CA** |
...
1. Create folder `ca-clients` in workspace.
2. One profile per account — tag `geo-ca`.
