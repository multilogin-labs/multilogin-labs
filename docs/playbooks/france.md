...
Operators in **France** use Multilogin for multi-account social, e-commerce, and ads. Currency: **EUR**. Popular stacks: Amazon FR, Cdiscount, TikTok FR.

## Recommended setup

| Item | Recommendation |
|---|---|
| Proxy | Residential or mobile in **FR** |
...
1. Create folder `fr-clients` in workspace.
2. One profile per account — tag `geo-fr`.
