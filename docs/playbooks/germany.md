# Germany MMO playbook (DE)

> [Multilogin partner pricing →](https://multilogin.com/pricing/?utm_source=saas&utm_medium=partner&a_aid=saas&a_bid=f5fad549) · **`SAAS50`** · **`MIN50`**

## Market overview

Operators in **Germany** use Multilogin for multi-account social, e-commerce, and ads. Currency: **EUR**. Popular stacks: Amazon DE, eBay Kleinanzeigen, Meta Ads EU.

## Recommended setup

| Item | Recommendation |
|---|---|
| Proxy | Residential or mobile in **DE** |
...
1. Create folder `de-clients` in workspace.
2. One profile per account — tag `geo-de`.
