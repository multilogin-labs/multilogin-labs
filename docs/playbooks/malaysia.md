...
Operators in **Malaysia** use Multilogin for multi-account social, e-commerce, and ads. Currency: **MYR**. Popular stacks: Shopee MY, Lazada, TikTok Shop.

## Recommended setup

| Item | Recommendation |
|---|---|
| Proxy | Residential or mobile in **MY** |
...
1. Create folder `my-clients` in workspace.
2. One profile per account — tag `geo-my`.
