...
Operators in **Saudi Arabia** use Multilogin for multi-account social, e-commerce, and ads. Currency: **SAR**. Popular stacks: Noon, Amazon SA, Snapchat.

## Recommended setup

| Item | Recommendation |
|---|---|
| Proxy | Residential or mobile in **SA** |
...
1. Create folder `sa-clients` in workspace.
2. One profile per account — tag `geo-sa`.
