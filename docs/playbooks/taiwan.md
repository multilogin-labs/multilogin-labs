...
Operators in **Taiwan** use Multilogin for multi-account social, e-commerce, and ads. Currency: **TWD**. Popular stacks: Shopee TW, PChome, LINE marketing.

## Recommended setup

| Item | Recommendation |
|---|---|
| Proxy | Residential or mobile in **TW** |
...
1. Create folder `tw-clients` in workspace.
2. One profile per account — tag `geo-tw`.
